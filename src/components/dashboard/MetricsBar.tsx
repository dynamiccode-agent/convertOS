      ...
      <div className="px-6 py-4">
        ...
        <div className="mb-4">
          <select
            ...
            className="text-lg font-semibold px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-violet-500 focus:border-transparent min-w-[300px]"
          >
