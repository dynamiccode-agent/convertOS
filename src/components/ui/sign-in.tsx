...
export const SignInPage: React.FC<SignInPageProps> = ({
  title = <span className="font-light text-foreground tracking-tighter">Welcome to <strong className="font-semibold">ConvertOS</strong></span>,
  description = "Meta Ads Intelligence Platform - Access your dashboard and optimize your campaigns",
  heroImageSrc,
  testimonials = [],
  onSignIn,
}) => {
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl bg-black dark:bg-white py-4 font-medium text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 transition-colors">
                Sign In
              </button>
            </form>
          </div>
